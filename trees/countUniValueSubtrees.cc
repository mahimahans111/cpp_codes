#include<iostream>
 ...
 // It takes as input the root node of the given tree. It should return the count of univalue subtrees.
 bool isSameValSubtree(TreeNode*root){
   ...
   int countUnivalSubtrees(TreeNode*root){
   	...
   	int x = countUnivalSubtrees(root->left);
   	int y = countUnivalSubtrees(root->right);
